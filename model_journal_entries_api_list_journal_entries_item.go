...
// checks if the JournalEntriesApiListJournalEntriesItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JournalEntriesApiListJournalEntriesItem{}

// JournalEntriesApiListJournalEntriesItem The Journal Entry model.
type JournalEntriesApiListJournalEntriesItem struct {
...
func NewJournalEntriesApiListJournalEntriesItem() *JournalEntriesApiListJournalEntriesItem {
	this := JournalEntriesApiListJournalEntriesItem{}
	return &this
}
...
func (o JournalEntriesApiListJournalEntriesItem) MarshalJSON() ([]byte, error) {
...
func (o JournalEntriesApiListJournalEntriesItem) ToMap() (map[string]interface{}, error) {
...
type NullableJournalEntriesApiListJournalEntriesItem struct {
	value *JournalEntriesApiListJournalEntriesItem
	isSet bool
}

func (v NullableJournalEntriesApiListJournalEntriesItem) Get() *JournalEntriesApiListJournalEntriesItem {
	return v.value
}

func (v *NullableJournalEntriesApiListJournalEntriesItem) Set(val *JournalEntriesApiListJournalEntriesItem) {
	v.value = val
	v.isSet = true
}

func (v NullableJournalEntriesApiListJournalEntriesItem) IsSet() bool {
	return v.isSet
}

func (v *NullableJournalEntriesApiListJournalEntriesItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJournalEntriesApiListJournalEntriesItem(val *JournalEntriesApiListJournalEntriesItem) *NullableJournalEntriesApiListJournalEntriesItem {
	return &NullableJournalEntriesApiListJournalEntriesItem{value: val, isSet: true}
}

func (v NullableJournalEntriesApiListJournalEntriesItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJournalEntriesApiListJournalEntriesItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
