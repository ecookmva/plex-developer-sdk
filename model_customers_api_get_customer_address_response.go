...
// checks if the CustomersApiGetCustomerAddressResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomersApiGetCustomerAddressResponse{}

// CustomersApiGetCustomerAddressResponse The all-inclusive domain model for a [object Object].
type CustomersApiGetCustomerAddressResponse struct {
...
func NewCustomersApiGetCustomerAddressResponse() *CustomersApiGetCustomerAddressResponse {
	this := CustomersApiGetCustomerAddressResponse{}
	return &this
}
...
func (o CustomersApiGetCustomerAddressResponse) MarshalJSON() ([]byte, error) {
...
func (o CustomersApiGetCustomerAddressResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCustomersApiGetCustomerAddressResponse struct {
	value *CustomersApiGetCustomerAddressResponse
	isSet bool
}

func (v NullableCustomersApiGetCustomerAddressResponse) Get() *CustomersApiGetCustomerAddressResponse {
	return v.value
}

func (v *NullableCustomersApiGetCustomerAddressResponse) Set(val *CustomersApiGetCustomerAddressResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomersApiGetCustomerAddressResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomersApiGetCustomerAddressResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomersApiGetCustomerAddressResponse(val *CustomersApiGetCustomerAddressResponse) *NullableCustomersApiGetCustomerAddressResponse {
	return &NullableCustomersApiGetCustomerAddressResponse{value: val, isSet: true}
}

func (v NullableCustomersApiGetCustomerAddressResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomersApiGetCustomerAddressResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
