...
// checks if the SupplyItemsApiDeleteSupplyItemResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupplyItemsApiDeleteSupplyItemResponse{}

// SupplyItemsApiDeleteSupplyItemResponse The Supply Item model.
type SupplyItemsApiDeleteSupplyItemResponse struct {
...
func NewSupplyItemsApiDeleteSupplyItemResponse() *SupplyItemsApiDeleteSupplyItemResponse {
	this := SupplyItemsApiDeleteSupplyItemResponse{}
	return &this
}
...
func (o SupplyItemsApiDeleteSupplyItemResponse) MarshalJSON() ([]byte, error) {
...
func (o SupplyItemsApiDeleteSupplyItemResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSupplyItemsApiDeleteSupplyItemResponse struct {
	value *SupplyItemsApiDeleteSupplyItemResponse
	isSet bool
}

func (v NullableSupplyItemsApiDeleteSupplyItemResponse) Get() *SupplyItemsApiDeleteSupplyItemResponse {
	return v.value
}

func (v *NullableSupplyItemsApiDeleteSupplyItemResponse) Set(val *SupplyItemsApiDeleteSupplyItemResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupplyItemsApiDeleteSupplyItemResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupplyItemsApiDeleteSupplyItemResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupplyItemsApiDeleteSupplyItemResponse(val *SupplyItemsApiDeleteSupplyItemResponse) *NullableSupplyItemsApiDeleteSupplyItemResponse {
	return &NullableSupplyItemsApiDeleteSupplyItemResponse{value: val, isSet: true}
}

func (v NullableSupplyItemsApiDeleteSupplyItemResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupplyItemsApiDeleteSupplyItemResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
