...
// checks if the CustomersApiUpdateCustomerAddressResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomersApiUpdateCustomerAddressResponse{}

// CustomersApiUpdateCustomerAddressResponse The all-inclusive domain model for a [object Object].
type CustomersApiUpdateCustomerAddressResponse struct {
...
func NewCustomersApiUpdateCustomerAddressResponse() *CustomersApiUpdateCustomerAddressResponse {
	this := CustomersApiUpdateCustomerAddressResponse{}
	return &this
}
...
func (o CustomersApiUpdateCustomerAddressResponse) MarshalJSON() ([]byte, error) {
...
func (o CustomersApiUpdateCustomerAddressResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCustomersApiUpdateCustomerAddressResponse struct {
	value *CustomersApiUpdateCustomerAddressResponse
	isSet bool
}

func (v NullableCustomersApiUpdateCustomerAddressResponse) Get() *CustomersApiUpdateCustomerAddressResponse {
	return v.value
}

func (v *NullableCustomersApiUpdateCustomerAddressResponse) Set(val *CustomersApiUpdateCustomerAddressResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomersApiUpdateCustomerAddressResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomersApiUpdateCustomerAddressResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomersApiUpdateCustomerAddressResponse(val *CustomersApiUpdateCustomerAddressResponse) *NullableCustomersApiUpdateCustomerAddressResponse {
	return &NullableCustomersApiUpdateCustomerAddressResponse{value: val, isSet: true}
}

func (v NullableCustomersApiUpdateCustomerAddressResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomersApiUpdateCustomerAddressResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
