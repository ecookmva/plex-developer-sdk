...
// checks if the PartsApiUpdatePartRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartsApiUpdatePartRequest{}

// PartsApiUpdatePartRequest The part model exposed for updating.
type PartsApiUpdatePartRequest struct {
...
func NewPartsApiUpdatePartRequest() *PartsApiUpdatePartRequest {
	this := PartsApiUpdatePartRequest{}
	return &this
}
...
func (o PartsApiUpdatePartRequest) MarshalJSON() ([]byte, error) {
...
func (o PartsApiUpdatePartRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePartsApiUpdatePartRequest struct {
	value *PartsApiUpdatePartRequest
	isSet bool
}

func (v NullablePartsApiUpdatePartRequest) Get() *PartsApiUpdatePartRequest {
	return v.value
}

func (v *NullablePartsApiUpdatePartRequest) Set(val *PartsApiUpdatePartRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePartsApiUpdatePartRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePartsApiUpdatePartRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartsApiUpdatePartRequest(val *PartsApiUpdatePartRequest) *NullablePartsApiUpdatePartRequest {
	return &NullablePartsApiUpdatePartRequest{value: val, isSet: true}
}

func (v NullablePartsApiUpdatePartRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartsApiUpdatePartRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
