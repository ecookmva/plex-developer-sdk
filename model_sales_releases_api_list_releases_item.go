...
// checks if the SalesReleasesApiListReleasesItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SalesReleasesApiListReleasesItem{}

// SalesReleasesApiListReleasesItem The Release model exposed for adding.
type SalesReleasesApiListReleasesItem struct {
...
func NewSalesReleasesApiListReleasesItem() *SalesReleasesApiListReleasesItem {
	this := SalesReleasesApiListReleasesItem{}
	return &this
}
...
func (o SalesReleasesApiListReleasesItem) MarshalJSON() ([]byte, error) {
...
func (o SalesReleasesApiListReleasesItem) ToMap() (map[string]interface{}, error) {
...
type NullableSalesReleasesApiListReleasesItem struct {
	value *SalesReleasesApiListReleasesItem
	isSet bool
}

func (v NullableSalesReleasesApiListReleasesItem) Get() *SalesReleasesApiListReleasesItem {
	return v.value
}

func (v *NullableSalesReleasesApiListReleasesItem) Set(val *SalesReleasesApiListReleasesItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSalesReleasesApiListReleasesItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSalesReleasesApiListReleasesItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSalesReleasesApiListReleasesItem(val *SalesReleasesApiListReleasesItem) *NullableSalesReleasesApiListReleasesItem {
	return &NullableSalesReleasesApiListReleasesItem{value: val, isSet: true}
}

func (v NullableSalesReleasesApiListReleasesItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSalesReleasesApiListReleasesItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
