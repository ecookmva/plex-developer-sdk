...
// checks if the CustomerPartsApiDeleteCustomerPartResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerPartsApiDeleteCustomerPartResponse{}

// CustomerPartsApiDeleteCustomerPartResponse The all-inclusive domain model for an Customer Part.
type CustomerPartsApiDeleteCustomerPartResponse struct {
...
func NewCustomerPartsApiDeleteCustomerPartResponse() *CustomerPartsApiDeleteCustomerPartResponse {
	this := CustomerPartsApiDeleteCustomerPartResponse{}
	return &this
}
...
func (o CustomerPartsApiDeleteCustomerPartResponse) MarshalJSON() ([]byte, error) {
...
func (o CustomerPartsApiDeleteCustomerPartResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCustomerPartsApiDeleteCustomerPartResponse struct {
	value *CustomerPartsApiDeleteCustomerPartResponse
	isSet bool
}

func (v NullableCustomerPartsApiDeleteCustomerPartResponse) Get() *CustomerPartsApiDeleteCustomerPartResponse {
	return v.value
}

func (v *NullableCustomerPartsApiDeleteCustomerPartResponse) Set(val *CustomerPartsApiDeleteCustomerPartResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerPartsApiDeleteCustomerPartResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerPartsApiDeleteCustomerPartResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerPartsApiDeleteCustomerPartResponse(val *CustomerPartsApiDeleteCustomerPartResponse) *NullableCustomerPartsApiDeleteCustomerPartResponse {
	return &NullableCustomerPartsApiDeleteCustomerPartResponse{value: val, isSet: true}
}

func (v NullableCustomerPartsApiDeleteCustomerPartResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerPartsApiDeleteCustomerPartResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
