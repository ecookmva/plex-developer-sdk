...
// checks if the ControlPlansApiListControlPlansItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ControlPlansApiListControlPlansItem{}

// ControlPlansApiListControlPlansItem The data structure representing a control plan.
type ControlPlansApiListControlPlansItem struct {
...
func NewControlPlansApiListControlPlansItem() *ControlPlansApiListControlPlansItem {
	this := ControlPlansApiListControlPlansItem{}
	return &this
}
...
func (o ControlPlansApiListControlPlansItem) MarshalJSON() ([]byte, error) {
...
func (o ControlPlansApiListControlPlansItem) ToMap() (map[string]interface{}, error) {
...
type NullableControlPlansApiListControlPlansItem struct {
	value *ControlPlansApiListControlPlansItem
	isSet bool
}

func (v NullableControlPlansApiListControlPlansItem) Get() *ControlPlansApiListControlPlansItem {
	return v.value
}

func (v *NullableControlPlansApiListControlPlansItem) Set(val *ControlPlansApiListControlPlansItem) {
	v.value = val
	v.isSet = true
}

func (v NullableControlPlansApiListControlPlansItem) IsSet() bool {
	return v.isSet
}

func (v *NullableControlPlansApiListControlPlansItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableControlPlansApiListControlPlansItem(val *ControlPlansApiListControlPlansItem) *NullableControlPlansApiListControlPlansItem {
	return &NullableControlPlansApiListControlPlansItem{value: val, isSet: true}
}

func (v NullableControlPlansApiListControlPlansItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableControlPlansApiListControlPlansItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
