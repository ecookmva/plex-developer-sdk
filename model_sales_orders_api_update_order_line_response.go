...
// checks if the SalesOrdersApiUpdateOrderLineResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SalesOrdersApiUpdateOrderLineResponse{}

// SalesOrdersApiUpdateOrderLineResponse The Order Lines model exposed.
type SalesOrdersApiUpdateOrderLineResponse struct {
...
func NewSalesOrdersApiUpdateOrderLineResponse() *SalesOrdersApiUpdateOrderLineResponse {
	this := SalesOrdersApiUpdateOrderLineResponse{}
	return &this
}
...
func (o SalesOrdersApiUpdateOrderLineResponse) MarshalJSON() ([]byte, error) {
...
func (o SalesOrdersApiUpdateOrderLineResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSalesOrdersApiUpdateOrderLineResponse struct {
	value *SalesOrdersApiUpdateOrderLineResponse
	isSet bool
}

func (v NullableSalesOrdersApiUpdateOrderLineResponse) Get() *SalesOrdersApiUpdateOrderLineResponse {
	return v.value
}

func (v *NullableSalesOrdersApiUpdateOrderLineResponse) Set(val *SalesOrdersApiUpdateOrderLineResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSalesOrdersApiUpdateOrderLineResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSalesOrdersApiUpdateOrderLineResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSalesOrdersApiUpdateOrderLineResponse(val *SalesOrdersApiUpdateOrderLineResponse) *NullableSalesOrdersApiUpdateOrderLineResponse {
	return &NullableSalesOrdersApiUpdateOrderLineResponse{value: val, isSet: true}
}

func (v NullableSalesOrdersApiUpdateOrderLineResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSalesOrdersApiUpdateOrderLineResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
