...
// checks if the KeyMeasurablesApiListMetricsItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyMeasurablesApiListMetricsItem{}

// KeyMeasurablesApiListMetricsItem The data structure representing a metric.
type KeyMeasurablesApiListMetricsItem struct {
	// The ID of a metric.
...
func NewKeyMeasurablesApiListMetricsItem() *KeyMeasurablesApiListMetricsItem {
	this := KeyMeasurablesApiListMetricsItem{}
	return &this
}
...
func (o KeyMeasurablesApiListMetricsItem) MarshalJSON() ([]byte, error) {
...
func (o KeyMeasurablesApiListMetricsItem) ToMap() (map[string]interface{}, error) {
...
type NullableKeyMeasurablesApiListMetricsItem struct {
	value *KeyMeasurablesApiListMetricsItem
	isSet bool
}

func (v NullableKeyMeasurablesApiListMetricsItem) Get() *KeyMeasurablesApiListMetricsItem {
	return v.value
}

func (v *NullableKeyMeasurablesApiListMetricsItem) Set(val *KeyMeasurablesApiListMetricsItem) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyMeasurablesApiListMetricsItem) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyMeasurablesApiListMetricsItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyMeasurablesApiListMetricsItem(val *KeyMeasurablesApiListMetricsItem) *NullableKeyMeasurablesApiListMetricsItem {
	return &NullableKeyMeasurablesApiListMetricsItem{value: val, isSet: true}
}

func (v NullableKeyMeasurablesApiListMetricsItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyMeasurablesApiListMetricsItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
