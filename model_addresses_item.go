...
// checks if the AddressesItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressesItem{}

// AddressesItem The CustomerAddress model exposed for adding.
type AddressesItem struct {
...
func (o AddressesItem) MarshalJSON() ([]byte, error) {
...
func (o AddressesItem) ToMap() (map[string]interface{}, error) {
...
type NullableAddressesItem struct {
	value *AddressesItem
	isSet bool
}

func (v NullableAddressesItem) Get() *AddressesItem {
	return v.value
}

func (v *NullableAddressesItem) Set(val *AddressesItem) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressesItem) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressesItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressesItem(val *AddressesItem) *NullableAddressesItem {
	return &NullableAddressesItem{value: val, isSet: true}
}

func (v NullableAddressesItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressesItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
