...
// checks if the PartsApiSyncPartsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartsApiSyncPartsRequest{}

// PartsApiSyncPartsRequest The full Part Resource structure.
type PartsApiSyncPartsRequest struct {
...
func (o PartsApiSyncPartsRequest) MarshalJSON() ([]byte, error) {
...
func (o PartsApiSyncPartsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePartsApiSyncPartsRequest struct {
	value *PartsApiSyncPartsRequest
	isSet bool
}

func (v NullablePartsApiSyncPartsRequest) Get() *PartsApiSyncPartsRequest {
	return v.value
}

func (v *NullablePartsApiSyncPartsRequest) Set(val *PartsApiSyncPartsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePartsApiSyncPartsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePartsApiSyncPartsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartsApiSyncPartsRequest(val *PartsApiSyncPartsRequest) *NullablePartsApiSyncPartsRequest {
	return &NullablePartsApiSyncPartsRequest{value: val, isSet: true}
}

func (v NullablePartsApiSyncPartsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartsApiSyncPartsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
