...
// checks if the JustInSequenceApiGetJISReleaseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JustInSequenceApiGetJISReleaseResponse{}

// JustInSequenceApiGetJISReleaseResponse The Sequenced Release model.
type JustInSequenceApiGetJISReleaseResponse struct {
...
func NewJustInSequenceApiGetJISReleaseResponse() *JustInSequenceApiGetJISReleaseResponse {
	this := JustInSequenceApiGetJISReleaseResponse{}
	return &this
}
...
func (o JustInSequenceApiGetJISReleaseResponse) MarshalJSON() ([]byte, error) {
...
func (o JustInSequenceApiGetJISReleaseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableJustInSequenceApiGetJISReleaseResponse struct {
	value *JustInSequenceApiGetJISReleaseResponse
	isSet bool
}

func (v NullableJustInSequenceApiGetJISReleaseResponse) Get() *JustInSequenceApiGetJISReleaseResponse {
	return v.value
}

func (v *NullableJustInSequenceApiGetJISReleaseResponse) Set(val *JustInSequenceApiGetJISReleaseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableJustInSequenceApiGetJISReleaseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableJustInSequenceApiGetJISReleaseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJustInSequenceApiGetJISReleaseResponse(val *JustInSequenceApiGetJISReleaseResponse) *NullableJustInSequenceApiGetJISReleaseResponse {
	return &NullableJustInSequenceApiGetJISReleaseResponse{value: val, isSet: true}
}

func (v NullableJustInSequenceApiGetJISReleaseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJustInSequenceApiGetJISReleaseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
