...
// checks if the CustomerPartsApiUpdateCustomerPartResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerPartsApiUpdateCustomerPartResponse{}

// CustomerPartsApiUpdateCustomerPartResponse The all-inclusive domain model for an Customer Part.
type CustomerPartsApiUpdateCustomerPartResponse struct {
...
func NewCustomerPartsApiUpdateCustomerPartResponse() *CustomerPartsApiUpdateCustomerPartResponse {
	this := CustomerPartsApiUpdateCustomerPartResponse{}
	return &this
}
...
func (o CustomerPartsApiUpdateCustomerPartResponse) MarshalJSON() ([]byte, error) {
...
func (o CustomerPartsApiUpdateCustomerPartResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCustomerPartsApiUpdateCustomerPartResponse struct {
	value *CustomerPartsApiUpdateCustomerPartResponse
	isSet bool
}

func (v NullableCustomerPartsApiUpdateCustomerPartResponse) Get() *CustomerPartsApiUpdateCustomerPartResponse {
	return v.value
}

func (v *NullableCustomerPartsApiUpdateCustomerPartResponse) Set(val *CustomerPartsApiUpdateCustomerPartResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerPartsApiUpdateCustomerPartResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerPartsApiUpdateCustomerPartResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerPartsApiUpdateCustomerPartResponse(val *CustomerPartsApiUpdateCustomerPartResponse) *NullableCustomerPartsApiUpdateCustomerPartResponse {
	return &NullableCustomerPartsApiUpdateCustomerPartResponse{value: val, isSet: true}
}

func (v NullableCustomerPartsApiUpdateCustomerPartResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerPartsApiUpdateCustomerPartResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
