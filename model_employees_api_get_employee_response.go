...
// checks if the EmployeesApiGetEmployeeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployeesApiGetEmployeeResponse{}

// EmployeesApiGetEmployeeResponse All properties related to an Employee.
type EmployeesApiGetEmployeeResponse struct {
...
func NewEmployeesApiGetEmployeeResponse() *EmployeesApiGetEmployeeResponse {
	this := EmployeesApiGetEmployeeResponse{}
	return &this
}
...
func (o EmployeesApiGetEmployeeResponse) MarshalJSON() ([]byte, error) {
...
func (o EmployeesApiGetEmployeeResponse) ToMap() (map[string]interface{}, error) {
...
type NullableEmployeesApiGetEmployeeResponse struct {
	value *EmployeesApiGetEmployeeResponse
	isSet bool
}

func (v NullableEmployeesApiGetEmployeeResponse) Get() *EmployeesApiGetEmployeeResponse {
	return v.value
}

func (v *NullableEmployeesApiGetEmployeeResponse) Set(val *EmployeesApiGetEmployeeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployeesApiGetEmployeeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployeesApiGetEmployeeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployeesApiGetEmployeeResponse(val *EmployeesApiGetEmployeeResponse) *NullableEmployeesApiGetEmployeeResponse {
	return &NullableEmployeesApiGetEmployeeResponse{value: val, isSet: true}
}

func (v NullableEmployeesApiGetEmployeeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployeesApiGetEmployeeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
