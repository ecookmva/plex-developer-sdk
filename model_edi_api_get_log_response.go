...
// checks if the EdiApiGetLogResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EdiApiGetLogResponse{}

// EdiApiGetLogResponse API Resource for EDI Log
type EdiApiGetLogResponse struct {
...
func (o EdiApiGetLogResponse) MarshalJSON() ([]byte, error) {
...
func (o EdiApiGetLogResponse) ToMap() (map[string]interface{}, error) {
...
type NullableEdiApiGetLogResponse struct {
	value *EdiApiGetLogResponse
	isSet bool
}

func (v NullableEdiApiGetLogResponse) Get() *EdiApiGetLogResponse {
	return v.value
}

func (v *NullableEdiApiGetLogResponse) Set(val *EdiApiGetLogResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEdiApiGetLogResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEdiApiGetLogResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEdiApiGetLogResponse(val *EdiApiGetLogResponse) *NullableEdiApiGetLogResponse {
	return &NullableEdiApiGetLogResponse{value: val, isSet: true}
}

func (v NullableEdiApiGetLogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEdiApiGetLogResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
