...
// checks if the CustomersApiCreateCustomerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomersApiCreateCustomerRequest{}

// CustomersApiCreateCustomerRequest The customer model exposed for adding.
...
func NewCustomersApiCreateCustomerRequest() *CustomersApiCreateCustomerRequest {
	this := CustomersApiCreateCustomerRequest{}
	return &this
}
...
func (o CustomersApiCreateCustomerRequest) MarshalJSON() ([]byte, error) {
...
func (o CustomersApiCreateCustomerRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCustomersApiCreateCustomerRequest struct {
	value *CustomersApiCreateCustomerRequest
	isSet bool
}

func (v NullableCustomersApiCreateCustomerRequest) Get() *CustomersApiCreateCustomerRequest {
	return v.value
}

func (v *NullableCustomersApiCreateCustomerRequest) Set(val *CustomersApiCreateCustomerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomersApiCreateCustomerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomersApiCreateCustomerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomersApiCreateCustomerRequest(val *CustomersApiCreateCustomerRequest) *NullableCustomersApiCreateCustomerRequest {
	return &NullableCustomersApiCreateCustomerRequest{value: val, isSet: true}
}

func (v NullableCustomersApiCreateCustomerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomersApiCreateCustomerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
