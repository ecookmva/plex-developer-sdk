...
// checks if the CustomerShippersApiGetCustomerShipperLineResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerShippersApiGetCustomerShipperLineResponse{}

// CustomerShippersApiGetCustomerShipperLineResponse The shipper line model exposed.
type CustomerShippersApiGetCustomerShipperLineResponse struct {
...
func NewCustomerShippersApiGetCustomerShipperLineResponse() *CustomerShippersApiGetCustomerShipperLineResponse {
	this := CustomerShippersApiGetCustomerShipperLineResponse{}
	return &this
}
...
func (o CustomerShippersApiGetCustomerShipperLineResponse) MarshalJSON() ([]byte, error) {
...
func (o CustomerShippersApiGetCustomerShipperLineResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCustomerShippersApiGetCustomerShipperLineResponse struct {
	value *CustomerShippersApiGetCustomerShipperLineResponse
	isSet bool
}

func (v NullableCustomerShippersApiGetCustomerShipperLineResponse) Get() *CustomerShippersApiGetCustomerShipperLineResponse {
	return v.value
}

func (v *NullableCustomerShippersApiGetCustomerShipperLineResponse) Set(val *CustomerShippersApiGetCustomerShipperLineResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerShippersApiGetCustomerShipperLineResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerShippersApiGetCustomerShipperLineResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerShippersApiGetCustomerShipperLineResponse(val *CustomerShippersApiGetCustomerShipperLineResponse) *NullableCustomerShippersApiGetCustomerShipperLineResponse {
	return &NullableCustomerShippersApiGetCustomerShipperLineResponse{value: val, isSet: true}
}

func (v NullableCustomerShippersApiGetCustomerShipperLineResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerShippersApiGetCustomerShipperLineResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
