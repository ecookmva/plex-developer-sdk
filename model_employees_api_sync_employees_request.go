...
// checks if the EmployeesApiSyncEmployeesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployeesApiSyncEmployeesRequest{}

// EmployeesApiSyncEmployeesRequest All properties related to an Employee.
type EmployeesApiSyncEmployeesRequest struct {
...
func NewEmployeesApiSyncEmployeesRequest() *EmployeesApiSyncEmployeesRequest {
	this := EmployeesApiSyncEmployeesRequest{}
	return &this
}
...
func (o EmployeesApiSyncEmployeesRequest) MarshalJSON() ([]byte, error) {
...
func (o EmployeesApiSyncEmployeesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableEmployeesApiSyncEmployeesRequest struct {
	value *EmployeesApiSyncEmployeesRequest
	isSet bool
}

func (v NullableEmployeesApiSyncEmployeesRequest) Get() *EmployeesApiSyncEmployeesRequest {
	return v.value
}

func (v *NullableEmployeesApiSyncEmployeesRequest) Set(val *EmployeesApiSyncEmployeesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployeesApiSyncEmployeesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployeesApiSyncEmployeesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployeesApiSyncEmployeesRequest(val *EmployeesApiSyncEmployeesRequest) *NullableEmployeesApiSyncEmployeesRequest {
	return &NullableEmployeesApiSyncEmployeesRequest{value: val, isSet: true}
}

func (v NullableEmployeesApiSyncEmployeesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployeesApiSyncEmployeesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
