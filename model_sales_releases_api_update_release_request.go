...
// checks if the SalesReleasesApiUpdateReleaseRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SalesReleasesApiUpdateReleaseRequest{}

// SalesReleasesApiUpdateReleaseRequest The release model exposed for updating.
type SalesReleasesApiUpdateReleaseRequest struct {
...
func NewSalesReleasesApiUpdateReleaseRequest() *SalesReleasesApiUpdateReleaseRequest {
	this := SalesReleasesApiUpdateReleaseRequest{}
	return &this
}
...
func (o SalesReleasesApiUpdateReleaseRequest) MarshalJSON() ([]byte, error) {
...
func (o SalesReleasesApiUpdateReleaseRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSalesReleasesApiUpdateReleaseRequest struct {
	value *SalesReleasesApiUpdateReleaseRequest
	isSet bool
}

func (v NullableSalesReleasesApiUpdateReleaseRequest) Get() *SalesReleasesApiUpdateReleaseRequest {
	return v.value
}

func (v *NullableSalesReleasesApiUpdateReleaseRequest) Set(val *SalesReleasesApiUpdateReleaseRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSalesReleasesApiUpdateReleaseRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSalesReleasesApiUpdateReleaseRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSalesReleasesApiUpdateReleaseRequest(val *SalesReleasesApiUpdateReleaseRequest) *NullableSalesReleasesApiUpdateReleaseRequest {
	return &NullableSalesReleasesApiUpdateReleaseRequest{value: val, isSet: true}
}

func (v NullableSalesReleasesApiUpdateReleaseRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSalesReleasesApiUpdateReleaseRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
