...
// checks if the SupplyItemsApiGetSupplyItemResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupplyItemsApiGetSupplyItemResponse{}

// SupplyItemsApiGetSupplyItemResponse The Supply Item model.
type SupplyItemsApiGetSupplyItemResponse struct {
...
func NewSupplyItemsApiGetSupplyItemResponse() *SupplyItemsApiGetSupplyItemResponse {
	this := SupplyItemsApiGetSupplyItemResponse{}
	return &this
}
...
func (o SupplyItemsApiGetSupplyItemResponse) MarshalJSON() ([]byte, error) {
...
func (o SupplyItemsApiGetSupplyItemResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSupplyItemsApiGetSupplyItemResponse struct {
	value *SupplyItemsApiGetSupplyItemResponse
	isSet bool
}

func (v NullableSupplyItemsApiGetSupplyItemResponse) Get() *SupplyItemsApiGetSupplyItemResponse {
	return v.value
}

func (v *NullableSupplyItemsApiGetSupplyItemResponse) Set(val *SupplyItemsApiGetSupplyItemResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupplyItemsApiGetSupplyItemResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupplyItemsApiGetSupplyItemResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupplyItemsApiGetSupplyItemResponse(val *SupplyItemsApiGetSupplyItemResponse) *NullableSupplyItemsApiGetSupplyItemResponse {
	return &NullableSupplyItemsApiGetSupplyItemResponse{value: val, isSet: true}
}

func (v NullableSupplyItemsApiGetSupplyItemResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupplyItemsApiGetSupplyItemResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
