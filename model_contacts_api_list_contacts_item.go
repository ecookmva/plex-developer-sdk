...
// checks if the ContactsApiListContactsItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactsApiListContactsItem{}

// ContactsApiListContactsItem The all-inclusive domain model for a Contact.
type ContactsApiListContactsItem struct {
...
func NewContactsApiListContactsItem() *ContactsApiListContactsItem {
	this := ContactsApiListContactsItem{}
	return &this
}
...
func (o ContactsApiListContactsItem) MarshalJSON() ([]byte, error) {
...
func (o ContactsApiListContactsItem) ToMap() (map[string]interface{}, error) {
...
type NullableContactsApiListContactsItem struct {
	value *ContactsApiListContactsItem
	isSet bool
}

func (v NullableContactsApiListContactsItem) Get() *ContactsApiListContactsItem {
	return v.value
}

func (v *NullableContactsApiListContactsItem) Set(val *ContactsApiListContactsItem) {
	v.value = val
	v.isSet = true
}

func (v NullableContactsApiListContactsItem) IsSet() bool {
	return v.isSet
}

func (v *NullableContactsApiListContactsItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactsApiListContactsItem(val *ContactsApiListContactsItem) *NullableContactsApiListContactsItem {
	return &NullableContactsApiListContactsItem{value: val, isSet: true}
}

func (v NullableContactsApiListContactsItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactsApiListContactsItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
