...
// checks if the PurchaseOrdersApiListLineItemsItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PurchaseOrdersApiListLineItemsItem{}

// PurchaseOrdersApiListLineItemsItem The primary model for a Line Item.
type PurchaseOrdersApiListLineItemsItem struct {
...
func NewPurchaseOrdersApiListLineItemsItem() *PurchaseOrdersApiListLineItemsItem {
	this := PurchaseOrdersApiListLineItemsItem{}
	return &this
}
...
func (o PurchaseOrdersApiListLineItemsItem) MarshalJSON() ([]byte, error) {
...
func (o PurchaseOrdersApiListLineItemsItem) ToMap() (map[string]interface{}, error) {
...
type NullablePurchaseOrdersApiListLineItemsItem struct {
	value *PurchaseOrdersApiListLineItemsItem
	isSet bool
}

func (v NullablePurchaseOrdersApiListLineItemsItem) Get() *PurchaseOrdersApiListLineItemsItem {
	return v.value
}

func (v *NullablePurchaseOrdersApiListLineItemsItem) Set(val *PurchaseOrdersApiListLineItemsItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePurchaseOrdersApiListLineItemsItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePurchaseOrdersApiListLineItemsItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePurchaseOrdersApiListLineItemsItem(val *PurchaseOrdersApiListLineItemsItem) *NullablePurchaseOrdersApiListLineItemsItem {
	return &NullablePurchaseOrdersApiListLineItemsItem{value: val, isSet: true}
}

func (v NullablePurchaseOrdersApiListLineItemsItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePurchaseOrdersApiListLineItemsItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
