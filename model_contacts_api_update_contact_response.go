...
// checks if the ContactsApiUpdateContactResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactsApiUpdateContactResponse{}

// ContactsApiUpdateContactResponse The all-inclusive domain model for a Contact.
type ContactsApiUpdateContactResponse struct {
...
func NewContactsApiUpdateContactResponse() *ContactsApiUpdateContactResponse {
	this := ContactsApiUpdateContactResponse{}
	return &this
}
...
func (o ContactsApiUpdateContactResponse) MarshalJSON() ([]byte, error) {
...
func (o ContactsApiUpdateContactResponse) ToMap() (map[string]interface{}, error) {
...
type NullableContactsApiUpdateContactResponse struct {
	value *ContactsApiUpdateContactResponse
	isSet bool
}

func (v NullableContactsApiUpdateContactResponse) Get() *ContactsApiUpdateContactResponse {
	return v.value
}

func (v *NullableContactsApiUpdateContactResponse) Set(val *ContactsApiUpdateContactResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableContactsApiUpdateContactResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableContactsApiUpdateContactResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactsApiUpdateContactResponse(val *ContactsApiUpdateContactResponse) *NullableContactsApiUpdateContactResponse {
	return &NullableContactsApiUpdateContactResponse{value: val, isSet: true}
}

func (v NullableContactsApiUpdateContactResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactsApiUpdateContactResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
