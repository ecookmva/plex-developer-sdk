...
// checks if the ChartOfAccountsApiCreateAccountRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChartOfAccountsApiCreateAccountRequest{}

// ChartOfAccountsApiCreateAccountRequest struct for ChartOfAccountsApiCreateAccountRequest
type ChartOfAccountsApiCreateAccountRequest struct {
...
func NewChartOfAccountsApiCreateAccountRequest() *ChartOfAccountsApiCreateAccountRequest {
	this := ChartOfAccountsApiCreateAccountRequest{}
	return &this
}
...
func (o ChartOfAccountsApiCreateAccountRequest) MarshalJSON() ([]byte, error) {
...
func (o ChartOfAccountsApiCreateAccountRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChartOfAccountsApiCreateAccountRequest struct {
	value *ChartOfAccountsApiCreateAccountRequest
	isSet bool
}

func (v NullableChartOfAccountsApiCreateAccountRequest) Get() *ChartOfAccountsApiCreateAccountRequest {
	return v.value
}

func (v *NullableChartOfAccountsApiCreateAccountRequest) Set(val *ChartOfAccountsApiCreateAccountRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChartOfAccountsApiCreateAccountRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChartOfAccountsApiCreateAccountRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChartOfAccountsApiCreateAccountRequest(val *ChartOfAccountsApiCreateAccountRequest) *NullableChartOfAccountsApiCreateAccountRequest {
	return &NullableChartOfAccountsApiCreateAccountRequest{value: val, isSet: true}
}

func (v NullableChartOfAccountsApiCreateAccountRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChartOfAccountsApiCreateAccountRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
